    ...
    <div>
        ...
        <div className="flex-col place-content-center w-full sm:h-full mt-16 mb-24 ">
            ...
            <form onSubmit={onSubmit} className="flex items-center justify-center pb-10">
                <input value={searchValue} onChange={onChange} className="bg-white focus:outline-none focus:shadow-outline border focus:bg-white border-gray-300 rounded-lg py-2 px-4 block w-1/2 appearance-none leading-normal" type="text" placeholder="Search for recipes"/>
